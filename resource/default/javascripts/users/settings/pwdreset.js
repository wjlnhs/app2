...
define(function (require, exports) {
    var fw_form=require('/default/javascripts/common/fw_form.js');
    ...
    function ChangePassword(oldPassword,newPassword) {
        $.ajax({
            url: "/settings/ChangePassword?" + Math.random(),
            type: "post",
            dataType: "json",
            data: { "oldPassword": oldPassword, "newPassword": newPassword},
            success: function (data, textStatus) {
                if (data.Result) {
                    i8ui.simpleAlert("恭喜！修改密码成功");
                }
                else {
